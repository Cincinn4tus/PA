...
<main id="main">
    ...
    <div class="container-fluid">
        ...
        try {
            ...
            $newMessageStmt = $connection->prepare("SELECT COUNT(*) FROM messages WHERE recipient_id = :id AND is_read = 0");
            ...
            $stmt = $connection->prepare("SELECT messages.*, sender.firstname AS sender_firstname, sender.lastname AS sender_lastname, recipient.firstname AS recipient_firstname, recipient.lastname AS recipient_lastname FROM messages
                                        INNER JOIN pa_user AS sender ON sender.id = messages.sender_id
                                        INNER JOIN pa_user AS recipient ON recipient.id = messages.recipient_id
            ...
            if (empty($messages)) {
                ...
                foreach ($messages as $message) {
                    ...
                    if ($recipientId == $id && !$isRead) {
                        $markAsReadStmt = $connection->prepare("UPDATE messages SET is_read = 1 WHERE id = :message_id");
        ...
        <form action="sendMessage.php" method="post">
            ...
            <div>
                ...
                <select name="recipient_id" id="recipient_id">
                    <?php
                    $usersStmt = $connection->prepare("SELECT id, firstname, lastname FROM pa_user WHERE id != :id");
