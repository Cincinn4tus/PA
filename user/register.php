...
<?php
//faire en sorte que la variable captcha_solved en methode post soit = a 0
                            ...
                            <form action="../core/userAdd.php" method="POST" class="user">
                                <center>
                                    <form action="../core/userAdd.php" method="POST" class="user">
                                        ...
                                        <div class="containers" id="d4" style="display: block"></div>
                                        <div id="successMessage" style="display: none;">
                                       Captcha successfully solved!
                                        </div>
                                        <!-- Captcha solved input field -->
                                        <input type="hidden" id="captcha_solved" name="captcha_solved" value="0">
                                ...
                                <div id="d1" style="display: none">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" name="Phone_numberEI" placeholder="Le numéro de téléphone de l'entreprise" value="<?= (!empty($_SESSION["data"])) ? $_SESSION["data"]["Phone_numberEI"] : ""; ?>">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="number" class="form-control form-control-user" name="SiretEI" placeholder="Votre numéro Siret" value="<?= (!empty($_SESSION["data"])) ? $_SESSION["data"]["SiretEI"] : ""; ?>">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" name="nameEntrepriseEI" placeholder="Le nom de l'entreprise" value="<?= (!empty($_SESSION["data"])) ? $_SESSION["data"]["nameEntrepriseEI"] : ""; ?>">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        </br>
                                ...
                                <div id="d3" style="display: none">
                                    <center>
                                        <h1 class="h4 text-gray-900 mb-4">Compte Entrepreneur</h1>
                                    </center>
                                    <div class="form-group">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" name="Phone_numberEE" placeholder="Le numéro de téléphone de l'entreprise" value="<?= (!empty($_SESSION["data"])) ? $_SESSION["data"]["Phone_numberEE"] : ""; ?>">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="number" class="form-control form-control-user" name="SiretEE" placeholder="Votre numéro Siret" value="<?= (!empty($_SESSION["data"])) ? $_SESSION["data"]["SiretEE"] : ""; ?>">
                                        </div>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" name="nameEntrepriseEE" placeholder="Le nom de l'entreprise" value="<?= (!empty($_SESSION["data"])) ? $_SESSION["data"]["nameEntrepriseEE"] : ""; ?>">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        </br>
                                    ...
                                    <center>
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <div class="form-group col-md-12">
                                                <label for="projetsInvestis">Avez-vous déjà investi dans des projets ? Expliquez-nous en détail.</label>
                                                <textarea class="form-control" name="projetsInvestis" id="projetsInvestis"><?= (!empty($_SESSION["data"])) ? $_SESSION["data"]["projetsInvestis"] : ""; ?></textarea>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label for="projetFait">Avez-vous déjà réalisé des projets ? Expliquez-nous en détail.</label>
                                                <textarea class="form-control" name="projetFait" id="projetFait"><?= (!empty($_SESSION["data"])) ? $_SESSION["data"]["projetFait"] : ""; ?></textarea>
                                            </div>
                                            <br>
                                            <br>
                                        </div>
                ...
                <script>
                    ...
                    function checkSolution() {
                        ...
                        if (sortedPieces.every((piece, index) => piece.getAttribute("data-index") == index)) {
                            ...
                            document.getElementById("captcha_solved").value = '1'; // Set the value of captcha_solved to '1' when the puzzle is solved
