    ...
    <div class="row text-center">
        <div class="col-lg-4 col-md-6 col-sm-12 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form" action="register.php" method="post" onload="disabledBtn()">
                    <label id="gender" for="gender">
                        ...
                        Date de naissance :
                        <input type="date" id="birthdate" class="form-control" name="birthdate" placeholder="Votre date de naissance" onkeyup="verifyFields()" required="required"><br>
                        <div class="form-group form-check">
                            <input type="checkbox" id="accept-cgu" class="form-check-input" name="accept-cgu" required="required" onclick="verifyFields()">
                            <label for="accept-cgu" class="form-check-label">J'accepte les CGU</label>
                        </div>
