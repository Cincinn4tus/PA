...
<div class="container-fluid">
    ...
    try {
        $stmt = $connection->prepare("SELECT * FROM ".DB_PREFIX."user WHERE id = :id");
        ...
        if ($user) {
            ...
            $friendshipStmt = $connection->prepare("SELECT status, blocked_status FROM ".DB_PREFIX."friendship WHERE (user1_id = :user1_id AND user2_id = :user2_id) OR (user1_id = :user2_id AND user2_id = :user1_id)");
