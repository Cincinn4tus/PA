...
<body>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              ...
              <p>
                21, rue Érard <br>
                75012, Paris<br><br>
                <strong>Téléphone:</strong> +33 1 56 06 90 41<br>
                <strong>Email:</strong> contact@crowdhub.fr<br>
              </p>
          ...
          <div class="col-lg-2 col-md-3 footer-links">
            <h4>Nos Services</h4>
            <ul>
              <li><a href="#">Plateforme de crowdsourcing</a></li>
              <li><a href="#">Gestion de projets collaboratifs</a></li>
              <li><a href="#">Solutions d'innovation ouverte</a></li>
              <li><a href="#">Évaluation de l'expérience utilisateur</a></li>
              <li><a href="#">Consulting en crowdsourcing</a></li>
            </ul>
          </div><!-- End footer links column -->
          ...
          <div class="col-lg-2 col-md-3 footer-links">
            ...
            <ul>
              ...
              <li><a href="#">Demande de démo</a></li>
    ...
    <div class="footer-legal text-center position-relative">
      <div class="container">
        <div class="copyright">
          &copy; Tous droits réservés par <strong><span>CrowdHub</span></strong>.
        </div>
      </div>
    </div>
